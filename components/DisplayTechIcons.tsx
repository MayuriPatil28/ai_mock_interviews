...
//there are two types of SDKs that firebase offers
// ADMIN SDK - allows secure service side operations
// CLIENT SDK - allows direct interaction with web or mobile apps
